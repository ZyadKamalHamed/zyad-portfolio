    ...
    <footer className="night px-5 py-12 sm:px-10">
      <div className="mx-auto flex max-w-[1240px] flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-md text-sm text-white/60">Designer, developer and AI engineer in Sydney. Open to graduate software and AI roles from December 2026, and to freelance work now.</p>
        </div>
